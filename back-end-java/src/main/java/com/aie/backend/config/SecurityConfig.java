...
import com.aie.backend.modules.auth.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsExposeHeaders(configuration);
    ...
    private void corsExposeHeaders(CorsConfiguration configuration) {
